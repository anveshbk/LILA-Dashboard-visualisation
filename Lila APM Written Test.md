...
At Lila, we believe the role of a product manager is evolving beyond its traditional scope. The convergence of PC/console and mobile gaming, the emergence of AI, and other global trends are creating a new environment that will fundamentally reshape how we build and ship
...
4. Please use the following link to submit your assignment: https://wkf.ms/3HXxEp4
...
4. **Brief demo** --- be prepared to walk us through the tool in a 15-minute call
...
- Send us the hosted URL, git repo link, and architecture doc (share one doc link with all three deliverables)
